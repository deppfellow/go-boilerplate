...
// Backend system need to expose several endpoint, like when using kubernetes,
// or external tools to monitor etc., they need to access to particular endpoint
// need to return a succesful response.
import (
	"context"
	"fmt"
	"net/http"
